    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            // Room Code Row
            FadeInLeft(child: _buildRoomCodeRow(context)),
            SizedBox(height: 16.h),
            // Status Row
            FadeInRight(child: _buildStatusRow(context)),
            SizedBox(height: 16.h),
            // Players Row
            FadeInLeft(child: _buildPlayersRow(context)),
          ],
        ),
      ),
    );
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: FadeInUp(
                              ...
                              from: 300.h,
                              curve: Curves.elasticOut,
                              child: _buildAnimatedQRCode(roomCode),
                            ),
                          ),
